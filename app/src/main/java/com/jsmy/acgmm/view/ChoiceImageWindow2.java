...
import com.jsmy.acgmm.activity.MyActivity;

/**
 * Created by Administrator on 2018/1/24.
 */

public class ChoiceImageWindow2 extends PopupWindow implements View.OnClickListener {
    ...
    public ChoiceImageWindow2(MyActivity context, boolean isWall) {
        super(context);

...
public class UpLoadAdapter extends RecyclerView.Adapter<UpLoadAdapter.UpLoadHolder> {
    ...
    public UpLoadAdapter(UpLoadActivity context, List<VideoListBean.DataBean.ListBean> list) {
    ...
    @Override
    public void onBindViewHolder(UpLoadHolder holder, final int position) {
